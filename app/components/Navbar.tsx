...
const Navbar = (props: Props) => {
    ...
    const SignOut = () => {
        if(session && session.user){ 
            return (
                <ul className='py-5 px-1 text-neutral-600'>
                    <li className='hover:bg-gray-100 hover:text-neutral-900 px-5 cursor-pointer'>
                        {session.user.name}
                    </li>
                    <li onClick={() => signOut()} className='whitespace-nowrap hover:text-red-600 px-5 cursor-pointer'>
                        Sign Out
                    </li>
                    <li className='whitespace-nowrap hover:bg-gray-100 hover:text-neutral-900 px-5 cursor-pointer'>
       ...
       return (
             <ul>
                 <li onClick={() => signIn()} className='whitespace-nowrap hover:bg-gray-100 hover:text-neutral-900 px-5 cursor-pointer'>Sign In</li>
             </ul>
       )  
}
  return (
        ...
        <div className='flex items-center justify-between py-4 relative'>
            ...
            <div className='flex items-center space-x-4'>
                 ...
                 <div onClick={() => setShowProfile(!showProfile)} className='relative cursor-pointer'>
                     <Image src="/user.jpg" className='rounded-full object-cover' width={35} height={35} alt="" />
